...
const Hero: React.FC = () => {
  ...
  return (
    <div className="w-full h-full flex items-center justify-center bg-neutral-950 px-4 md:px-12">
      
      <div 
        className="w-full max-w-6xl h-full relative overflow-hidden bg-black rounded-sm group mx-auto cursor-pointer md:cursor-auto"
