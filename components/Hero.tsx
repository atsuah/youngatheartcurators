...
const Hero: React.FC = () => {
  ...
  return (
    <div className="w-full flex items-center justify-center relative py-10 md:py-20 px-6 md:px-8">
      <div className="max-w-6xl mx-auto w-full">
        ...
        >
          ...
          <img 
            ...
            className={`w-full h-auto object-contain transition-all duration-1000 ease-out opacity-90 ${
              isColorRevealed 
          ...
          <div className="absolute bottom-6 left-0 md:bottom-16 md:left-0 z-10 pl-6 md:pl-12">
